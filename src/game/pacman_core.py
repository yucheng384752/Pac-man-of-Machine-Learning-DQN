    ...
    while running:
        ...
        for e in pygame.event.get():
            if e.type == pygame.QUIT:
                ...
                elif e.key == pygame.K_LEFT:  player.want = (0,-1)
                elif e.key == pygame.K_RIGHT: player.want = (0, 1)
                elif e.key == pygame.K_UP:    player.want = (-1,0)
                elif e.key == pygame.K_DOWN:  player.want = (1, 0)
